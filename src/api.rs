...
cfg_if! {
  if #[cfg(feature = "ssr")] {
    ...
    fn inference_callback<'a>(stop_sequence: String, buf: &'a mut String, out_str: &'a mut String) -> impl FnMut(llm::InferenceRequest) -> Result<llm::InferenceFeedback, Infallible> + 'a {
